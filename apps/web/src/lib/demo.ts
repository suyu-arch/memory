...
export const demoTogetherIdeas: TogetherIdea[] = [
  ...
  { id: 'idea-pottery', personId: 'lin', personName: '小林', personAvatarUrl: demoPhotoPool[0]!, content: '一起做一对歪歪扭扭的陶杯', status: 'DONE', proposedBy: '小林', plannedAt: null, locationText: '愚园路陶艺店', note: '最后做出来的杯子比想象中可爱。', encounterId: 'summer-night', createdAt: '2026-05-08T13:20:00+08:00', updatedAt: '2026-06-01T19:20:00+08:00' },
];
